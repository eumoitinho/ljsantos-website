          ...
          <div className="container mx-auto px-6">
            <div className="flex justify-between items-center">
              <Link href="/" className="relative z-10">
                <Image src="/logo-white.png" alt="LJ Santos Logo" width={150} height={50} className="h-10 w-auto" />
              </Link>
            </div>
          </div>
        </header>
        ...
        >
          <div className="container mx-auto px-6 py-8">
            <div className="flex flex-col space-y-6 mt-16">
              ...
              <Link href="/contato" className="font-medium text-gray-800 hover:text-[#448b13]" onClick={toggleMenu}>
                {t("common.contact")}
              </Link>
              <Link href="/trabalhe-conosco" className="font-medium text-gray-800 hover:text-[#448b13]" onClick={toggleMenu}>
                {t("common.workWithUs")}
              </Link>
              <Link
                href="/solicite-orcamento"
